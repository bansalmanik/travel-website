        ...
        <section className="rounded-3xl border border-white/10 bg-slate-900/40 shadow-lg shadow-slate-950/30">
          ...
          {partnerRows.length === 0 ? (
            ...
            <div className="divide-y divide-white/5">
              <div className="grid grid-cols-2 gap-3 px-4 py-3 text-[11px] font-semibold uppercase tracking-[0.25em] text-slate-300/70 sm:grid-cols-[1.1fr_0.9fr_1fr] sm:gap-2 sm:px-6">
                <span>Partner</span>
              ...
              {partnerRows.map((partner) => (
                <div
                  ...
                  className="grid grid-cols-2 gap-3 px-4 py-3 text-sm text-slate-100 sm:grid-cols-[1.1fr_0.9fr_1fr] sm:gap-2 sm:px-6"
                >
