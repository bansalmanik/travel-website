...
const programName = "HSBC Market Place";
const pageTitle = `${programName} | Bank Programs | Miles Go Round`;
const pageDescription =
  "Get notified when our HSBC Market Place walkthrough launches with tips on pairing offers with partner redemptions.";

export const metadata: Metadata = {
  title: pageTitle,
  description: pageDescription,
  alternates: {
    canonical: "/travel-with-points/bank-programs/hsbc-market-place",
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    type: "article",
    url: "https://example.com/travel-with-points/bank-programs/hsbc-market-place",
  },
  twitter: {
...
export default function HsbcMarketPlacePage() {
  return (
