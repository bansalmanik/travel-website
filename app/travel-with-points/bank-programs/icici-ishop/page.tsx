...
const programName = "ICICI IShop";
const pageTitle = `${programName} | Bank Programs | Miles Go Round`;
const pageDescription =
  "Preview the future ICICI IShop guide covering category accelerators, partner transfers, and cashback combos.";

export const metadata: Metadata = {
  title: pageTitle,
  description: pageDescription,
  alternates: {
    canonical: "/travel-with-points/bank-programs/icici-ishop",
  },
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    type: "article",
    url: "https://example.com/travel-with-points/bank-programs/icici-ishop",
  },
  twitter: {
...
export default function IciciIshopPage() {
  return (
