    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-950 to-slate-900 text-slate-100">
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-16 px-6 py-20 lg:py-28">
        ...
        <ul className="flex flex-col gap-6">
          {resources.map((entry) => (
            <li key={entry.slug}>
              <article className="group flex flex-col gap-4 rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur transition duration-300 hover:-translate-y-0.5 hover:border-amber-200/30 hover:shadow-2xl hover:shadow-amber-200/10 sm:flex-row sm:items-start sm:gap-6">
