  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-white to-sky-50 text-slate-900">
      <header className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto flex max-w-3xl flex-col items-center px-5 pb-20 pt-12 text-white sm:items-start sm:px-6 sm:pb-28 sm:pt-20">
          <h1 className="mt-3 text-center text-3xl font-semibold leading-tight sm:text-left sm:text-5xl sm:leading-tight">
            Soulful travel stories and point-savvy guides for meaningful journeys.
          </h1>
          <p className="mt-4 text-center text-base text-amber-100/90 sm:text-left sm:text-xl">
            Go beyond checklists with thoughtfully curated itineraries, loyalty program strategies, and journaled field notes
            from real adventures.
          </p>
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3 sm:justify-start">
            {quickAnchors.map((anchor) => (
              <a
                key={anchor.href}
                className="rounded-full border border-white/30 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-white/90 transition hover:bg-white/15"
                href={anchor.href}
              >
                {anchor.label}
              </a>
          ...
          <div className="mt-8 flex w-full flex-col items-center gap-3 sm:w-auto sm:flex-row sm:items-center sm:gap-4">
            <Link
      ...
      <main className="mx-auto max-w-6xl space-y-20 px-5 py-14 sm:space-y-24 sm:px-6 sm:py-24">
        <section id="stories" aria-labelledby="stories-heading" className="space-y-12">
          ...
          <ul className="-mx-5 flex snap-x snap-mandatory gap-5 overflow-x-auto pb-4 no-scrollbar sm:gap-6 md:mx-0 md:grid md:grid-cols-3 md:gap-8 md:overflow-visible md:pb-0">
        ...
        >
          <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:items-center">
            ...
            <ul className="-mx-5 flex snap-x snap-mandatory gap-4 overflow-x-auto pb-4 no-scrollbar md:mx-0 md:grid md:grid-cols-2 md:gap-4 md:overflow-visible md:pb-0">
