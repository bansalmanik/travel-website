...
import { getPostsByCategory, VALID_CATEGORIES } from "@/lib/blog";
...
export default async function CategoryPage({ params }: CategoryPageProps) {
  if (!params.category || !VALID_CATEGORIES.includes(params.category as (typeof VALID_CATEGORIES)[number])) notFound();
