...
import { getAllBlogPosts, getBlogPost, getRelatedPosts, getCategoryInfo } from '@/lib/blog'

// These are reserved routes that should NOT be handled by this catch-all
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://milesgoround.com/${post.slug}`,
    },
    twitter: {
    ...
    alternates: {
      canonical: `https://milesgoround.com/${post.slug}`,
    },
  }
}
...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  // Reserved routes should 404 here (they have their own pages)
      ...
      <article className="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <div className="mt-12 border-t border-slate-100 pt-8">
          ...
          <div className="flex gap-3">
            <button className="flex items-center gap-2 rounded-lg bg-slate-100 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-200 transition-colors">
              Twitter
            </button>
            <button className="flex items-center gap-2 rounded-lg bg-slate-100 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-200 transition-colors">
              Facebook
